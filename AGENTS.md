# Agent Operating Instructions for readmesmoke

This file defines how AI agents and human maintainers should work in `readmesmoke`.

## Project Context

- Project: `readmesmoke`
- Repository: `git@github.com:rogerchappel/readmesmoke.git`
- Primary maintainer: ``
- Default branch: `main`
- Package manager: `npm`
